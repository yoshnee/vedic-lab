...
export const combustion: Deck = {
  ...
  cards: [
    ...
    },
    {
      ...
      body: "",
      points: [
        "Combustion sharply limits how much of a planet's energy actually reaches expression",
        "The planet is muffled: its significations still operate, but the results arrive weakened",
        "The weakness shows most during that planet's own dasha, when the chart leans on it hardest",
        "Sun-dominant periods also amplify the effect",
        "Exception: a combust planet ruling the current dasha still runs the period, dimmed but still in charge",
      ],
    },
    {
    ...
    },
    {
      ...
      footnote: "Only these five planets combust. The Moon, Rahu, and Ketu never do.",
      points: [
