  ...
  cards: [
    ...
    },
    {
      ...
      points: [
        ...
        "Draws on hour, half of day, lunar fortnight, month, season, solstice period",
        "Sub-calculations include Nathonnatha Bala, Paksha Bala, Tribhaga Bala",
      ],
    },
    {
      title: "Cheshta Bala",
      ...
      facts: [
        ...
        { label: "Retrograde", value: "Highly energised, highest score" },
        { label: "Fast motion", value: "Lower score" },
      ],
      points: [
        "Retrograde (vakri) reads as highly energised: high Chesta Bala",
        "Fast direct motion scores lower",
        "A slow retrograde Mars, moving against the current, scores highest",
    ...
    },
    {
      ...
      body: "",
      facts: [
        { label: "Source", value: "Fixed, innate luminosity" },
        { label: "Sun", value: "60 virupas (highest)" },
        { label: "Saturn", value: "8.57 virupas (lowest)" },
      ],
      points: [
        "The one component that never changes from chart to chart",
    ...
    },
    {
      ...
      points: [
        "Benefic gazes (Jupiter, Venus, Mercury, waxing Moon) push Drik Bala positive",
        "Malefic gazes (Saturn, Mars, Rahu) pull it negative",
    ...
    },
    {
      ...
      body: "",
      facts: [
        { label: "Unit", value: "60 Virupas = 1 Rupa" },
        { label: "Ratio", value: "Strength ÷ BPHS minimum" },
        { label: "Above 1.0×", value: "Bal-Yukta (strong)" },
        { label: "Below 1.0×", value: "Balaheena (weak)" },
      ],
      points: [
        "1.5× means 50% over its minimum; 0.8× means 20% short",
        "The ratio shows at a glance how much room the planet has to work with",
      ],
    },
  ],
};
